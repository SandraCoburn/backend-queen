...
router.get('/statistics/:date', async (req, res) => {
  //const data = require('../data/data.json');
  try {
...
router.get('/statistics/visitors/:date', async (req, res) => {
  //const data = require('../data/data.json');
  try {
    ...
    const filteredData = data.filter((site) => date == site.date.split('T')[0]);
...
router.get('/statistics/:date/:date2', async (req, res) => {
  //const data = require('../data/data.json');
  try {
    //Pull dates out of URL parameter
